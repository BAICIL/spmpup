...
def extract_suvr(atlas, pet, labels, suvr, fov=None):
    ...
    # Read the label information into a dictionary
    label_dict = {}
    with open(labels, 'r') as f:
        for line in f:
            ...
            label_dict[label_index] = roi_name

    # Get unique labels from atlas
    ...
    for label_index in unique_labels:
        roi_name = label_dict.get(label_index, f"Label_{label_index}")
